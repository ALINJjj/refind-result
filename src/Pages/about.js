    ...
    <>
      ...
      <div className="about">
        ...
        <p>
          ...
          information; a valuable source can create an invaluable product. We
          approach each of our clients with unique methods tailored specifically
          to each situation.
        </p>
        </div>
      ...
      <div className="about">
        <div className="ceo">
          ...
          <p>
            ...
            interest, express yourself, and share thoughts and ideas;
            unfortunately, many people we interact with daily are unaware of the
            impact certain words may have in directing the conversation to the
            desired outcome. Language; the forefront of any role in society.
            ...
            important as presentation; they go hand in hand. There are countless
            ways to approach people of interest, express yourself, and share
            thoughts and ideas; unfortunately, many people we interact with
            daily are unaware of the impact certain words may have in directing
            the conversation to the desired outcome. As young adults, we are
            pressured to study, not to learn; to obtain a degree, regardless of
            personal interest in the subject. Instead of being taught skills
            that apply in everyday life to excel in both personal and
            professional settings. How to dress, how to speak to others,
            ...
            Philosophy at Carleton University, Political economics at the
            American University of Science & Technology in Beirut, Lebanon, and
            his adoration of language which he gained through his studies,
            travel, and appreciation for the works of Dostoyevsky, Socrates,
            W.E. Henley, Machiavelli, and many others. Mr. Devry has both
            learned the value of language, in many of its forms and what can be
            discerned from it. ​ "I have made mistakes and learned from them,
            the right decisions and regretted them, and I have not only proven
            to others how great I am but more importantly to myself. This has
            played an immeasurable role in the growth I have experienced and
